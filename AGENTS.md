...
- **Skills are app-owned** in `<app>/.Codex/skills`; the suite-level `jsuite`
  skill lives in `.Codex/skills/` here at the root. `./jsuite setup` installs
...
.Codex/skills/   # suite-level skills (jsuite)
